        ...
        <div className={`sidebar ${isSidebarOpen ? 'open' : ''}`}>
          <nav className="nav-links">
            <div className="nav-top">
              ...
              <NavLink to="/admin-dashboard/products/list" onClick={closeSidebar}>
                <FaBoxOpen /> Products
              </NavLink>
              <NavLink to="/admin-dashboard/categories/list" onClick={closeSidebar}>
                <FaFolderOpen /> Categories
              </NavLink>
              <NavLink to="/admin-dashboard/orders/list" onClick={closeSidebar}>
                <FaFileInvoice /> Orders
              </NavLink>
              <NavLink to="/admin-dashboard/beneficiaries/list" onClick={closeSidebar}>
                <PiHandshakeFill /> Beneficiaries
              </NavLink>
              <NavLink to="/admin-dashboard/users/list" onClick={closeSidebar}>
                <FaUsers /> Users
              </NavLink>
              <NavLink to="/admin-dashboard/inboxes/list" onClick={closeSidebar}>
                <FaEnvelopeOpenText /> Inbox
              </NavLink>
              <NavLink to="/admin-dashboard/inventory/list" onClick={closeSidebar}>
                <FaChartBar /> Inventory
              </NavLink>
              <NavLink to="/admin-dashboard/warehouses/list" onClick={closeSidebar}>
                <FaWarehouse /> Warehouse
              </NavLink>
              <NavLink to="/admin-dashboard/reports/list" onClick={closeSidebar}>
                <FaChartLine /> Reports
              </NavLink>
